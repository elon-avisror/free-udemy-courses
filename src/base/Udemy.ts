...
export enum UdemySelector {
    // Login Page
    emailInput = '#email--1',
    passwordInput = '#id_password',
    loginSubmitButton = '#submit-id-submit',
    // Subscribe Pages
    courseSubmitButton1 = '#udemy > div.main-content-wrapper > div.main-content > div.paid-course-landing-page__container > div.sidebar-container-position-manager > div > div > div > div.course-landing-page_slider-menu-container > div > div.slider-menu--cta-button--3eii3 > div > button',
    courseSubmitButton2 = '#sg > div.main-content-wrapper > div.main-content > div.paid-course-landing-page__container > div.sidebar-container-position-manager > div > div > div > div.course-landing-page_slider-menu-container > div > div.slider-menu--cta-button--3eii3 > div > button',
